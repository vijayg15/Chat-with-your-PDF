...
from src.utils import load_pdfs, text_split, download_embeddings, initialize_llm, update_json
...
def main():
    ...
    if pdf is not None:
        ...
        text_chunks = text_split(extracted_data, c_size=1000, c_overlap=100)

        if os.path.isfile(save_path):
            os.remove(save_path)

        embeddings = download_embeddings(embd_model_name="text-embedding-3-small")
        ...
        llm = initialize_llm(model_name="gpt-4o-mini", temp=0.6)
